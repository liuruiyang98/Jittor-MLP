...
class CycleFC(nn.Module):
    ...
    def __init__(
        ...
        self.weight = jt.zeros((out_channels, in_channels // groups, 1, 1))  # kernel size == 1
    ...
    def gen_offset(self):
        ...
        offset (Tensor[batch_size, 2 * offset_groups * kernel_height * kernel_width,
            ...
            convolution kernel.
        """
        offset = jt.zeros((1, self.in_channels*2, 1, 1))
    ...
    def execute(self, input):
        ...
        """
        B, C, H, W = input.size()
        return deform_conv2d_jt(input, self.offset.expand(B, -1, H, W), self.weight, self.bias, stride=self.stride,
